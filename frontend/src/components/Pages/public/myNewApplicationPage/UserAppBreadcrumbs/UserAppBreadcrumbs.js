...
const UserAppBreadcrumbs = ({setCurr, curr, first, second, third, val, firstdis, seconddis, thirddis}) => 
{
    ...
    <div className="external-nab">
        ...
        <MyBreadSecond setCurr={setCurr} val={val} txt={<tspan><tspan>Πανεπιστήμιο προς</tspan><tspan x="70" dy="1.2em"> αντιστοίχηση</tspan></tspan>} curr={(curr===2 ? 0 : second)} disabled={seconddis}/>
