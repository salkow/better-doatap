...
const MyRegisterPage = () => 
{
    ...
    const submit = async () =>{
      ...
      if(Erroremail || Errorpassword || ErrorrepeatPassword || ErrorlastName || ErrorfirstName || Errorgender || Errordob || Errorphone || Errorafm || Errorid){
        return;
      }
                ...
                <div className="txtboxes-p">
                  ...
                  <div className="second-group">
                    <div className="second-other horizontal">
                      <MyTextBox txt="Επώνυμο" type="text" vaar={setLast} error={ErrorlastName} setError={setErrorLast} validate={(last, setError) =>{
                                                                                            if(last.value != ""){
                                                                                              setError("");
                                                                                            }else{
                                                                                              setError("This field is required")
                      ...
                      <MyTextBox txt="Όνομα" type="text" vaar={setFirst} error={ErrorfirstName} setError={setErrorFirst} validate={(first, setError) =>{
                                                                                            if(first.value != ""){
                                                                                              setError("");
                                                                                            }else{
                                                                                              setError("This field is required")
                    ...
                    <div className="second-other horizontal">
                      <MyRadioButton txt="Φύλο" items={myRadio} vaar={setGender} error={Errorgender} setError={setErrorGender}/>
                      <MyDatePicker txt="Ημερομηνία γέννησης" vaar={setDoB} error={Errordob} setError={setErrorDoB}/>
                    </div>
                    <MyTextBox txt="Τηλέφωνο Επικοινωνίας" type="text" vaar={setPhoneNum} error={Errorphone} setError={setErrorPhoneNum} validate={(phone, setError) =>{
                                                                                            var validRegex = /^\d*$/;
                  ...
                  <div className="third-group">
                    <div className="third-other horizontal">
                      <MyTextBox txt="Αριθμός ταυτοτητας ή  Αριθμος διαβατηριου" type="text" vaar={setID} error={Errorid} setError={setErrorID} validate={(id, setError) =>{
                                                                                                                                                            if(id.value != ""){
                                                                                                                                                              setError("");
                                                                                                                                                            }else{
                                                                                                                                                              setError("This field is required")
                      ...
                      <MyTextBox txt="ΑΦΜ" type="text" vaar={setAFM} error={Errorafm} setError={setErrorAFM} validate={(afm, setError) =>{
                                                                                                                if(afm.value != ""){
                                                                                                                  setError("");
                                                                                                                }else{
                                                                                                                  setError("This field is required")
