            ...
            <svg width="230" height="60" viewBox="0 0 230 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <mask id="path-1-inside-1_221_507" fill="white">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.41972 6.98456C1.89593 4.31793 3.8214 1 6.89269 1H205C207.209 1 209 2.79086 209 5V53C209 55.2091 207.209 57 205 57H6.89269C3.82139 57 1.89593 53.6821 3.41972 51.0154L14.8659 30.9846C15.5686 29.7548 15.5686 28.2452 14.8659 27.0154L3.41972 6.98456Z"/>
                    </mask>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3.41972 6.98456C1.89593 4.31793 3.8214 1 6.89269 1H205C207.209 1 209 2.79086 209 5V53C209 55.2091 207.209 57 205 57H6.89269C3.82139 57 1.89593 53.6821 3.41972 51.0154L14.8659 30.9846C15.5686 29.7548 15.5686 28.2452 14.8659 27.0154L3.41972 6.98456Z" fill={clr}/>
                    ...
                    <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill={txt_clr} font-family="Inter" font-size="14" font-weight="500" letter-spacing="0px" >{txt}</text>
                </g>
                <defs>
                <filter id="filter0_d_221_507" x="0.88678" y="0" width="210.113" height="60" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
