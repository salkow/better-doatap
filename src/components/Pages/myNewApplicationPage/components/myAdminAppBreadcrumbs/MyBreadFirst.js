            ...
            <svg width="230" height="60" viewBox="0 0 230 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <mask id="path-1-inside-1_216_519" fill="white">
                        <path fillRule="evenodd" clipRule="evenodd" d="M2 5C2 2.79086 3.79086 1 6 1H209.679C211.114 1 212.44 1.76914 213.152 3.01544L226.866 27.0154C227.569 28.2452 227.569 29.7548 226.866 30.9846L213.152 54.9846C212.44 56.2309 211.114 57 209.679 57H6C3.79086 57 2 55.2091 2 53V5Z"/>
                    </mask>
                    <path fillRule="evenodd" clipRule="evenodd" d="M2 5C2 2.79086 3.79086 1 6 1H209.679C211.114 1 212.44 1.76914 213.152 3.01544L226.866 27.0154C227.569 28.2452 227.569 29.7548 226.866 30.9846L213.152 54.9846C212.44 56.2309 211.114 57 209.679 57H6C3.79086 57 2 55.2091 2 53V5Z" fill={clr}/>
                ...
                <defs>
                    <filter id="filter0_d_216_519" x="0" y="0" width="229.393" height="60" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
